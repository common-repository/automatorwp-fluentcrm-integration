...
class AutomatorWP_FluentCRM_User_Tag extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add tag to user', 'automatorwp-fluentcrm-integration' ),
            'select_option'     => __( 'Add <strong>tag</strong> to user', 'automatorwp-fluentcrm-integration' ),
            /* translators: %1$s: Tag. */
            'edit_label'        => sprintf( __( 'Add tag %1$s', 'automatorwp-fluentcrm-integration' ), '{tag}' ),
            /* translators: %1$s: Tag. */
            'log_label'         => sprintf( __( 'Add tag %1$s', 'automatorwp-fluentcrm-integration' ), '{tag}' ),
            'options'           => array(
                'tag' => automatorwp_utilities_ajax_selector_option( array(
                    'field'             => 'tag',
                    'option_default'    => __( 'Select a tag', 'automatorwp-fluentcrm-integration' ),
                    'name'              => __( 'Tag:', 'automatorwp-fluentcrm-integration' ),
                    'option_custom'         => true,
                    'option_custom_desc'    => __( 'Tag ID', 'automatorwp-fluentcrm' ),
